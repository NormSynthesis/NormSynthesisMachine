...
public class PerformanceRangeChart {
	 ...
	 */
	public PerformanceRangeChart(NormSynthesisMachine nsm, Dimension dim, Goal goal,
			NetworkNode node) {
	...
	private void createChart(NetworkNode node) {
		...
		PerformanceRangeChartSeries nwSeries = 
				new PerformanceRangeChartSeries(nsm, network, node, dim, goal);
	...
	public void addSeries(NetworkNode node,
		...
		PerformanceRangeChartSeries nwSeries = 
				new PerformanceRangeChartSeries(nsm, network, node, dim, goal, type);
