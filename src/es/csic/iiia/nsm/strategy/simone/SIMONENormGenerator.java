 ...
 *
 */
public class SIMONENormGenerator {
	 ...
	 * 
	 */
	public SIMONENormGenerator(NormSynthesisSettings nsmSettings,
			Monitor monitor, DomainFunctions dmFunctions, SIMONEOperators operators) {
