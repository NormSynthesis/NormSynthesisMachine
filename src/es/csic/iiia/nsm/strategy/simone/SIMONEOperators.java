...
public class SIMONEOperators {
	...
	protected SIMONEStrategy strategy;						// the norm synthesis strategy
	 ...
	 */
	public SIMONEOperators(SIMONEStrategy strategy, NormReasoner normReasoner, 
	...
	public void generalise(Norm child, Norm parent) {		
		...
		for(Norm p : this.normativeNetwork.getParents(child)) {
			if(this.normativeNetwork.isRepresented(p)) {
				this.deactivate(child, NetworkNodeState.GENERALISED); // TODO: Cambiado
				break;
			}
		}
	}
