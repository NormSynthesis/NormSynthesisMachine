 ...
 *
 */
public class SIMONENormRefiner {
	 ...
	 */
	public SIMONENormRefiner(List<Dimension> normEvDimensions,
			...
			SIMONEOperators operators, NormGeneralisationMode genMode, int genStep) {
		...
		this.normClassifier = new SIMONENormClassifier(normEvDimensions,
