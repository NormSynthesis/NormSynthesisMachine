 ...
 */
public class SIMONEStrategy implements NormSynthesisStrategy {
	...
	protected SIMONENormGenerator normGenerator;
	protected SIMONENormEvaluator normEvaluator;
	protected SIMONENormClassifier normClassifier;
	protected SIMONENormRefiner normRefiner;
	 ...
	 */
	public SIMONEStrategy(NormSynthesisMachine nsm,
		...
		this.operators = new SIMONEOperators(this, normReasoner, nsm);
		this.utilityFunction = new SIMONEUtilityFunction();
		...
		this.normGenerator = new SIMONENormGenerator(nsmSettings, monitor,
				dmFunctions, operators);

		this.normEvaluator = new SIMONENormEvaluator(normEvDimensions,
				nsmSettings, dmFunctions, normativeNetwork, normGroupNetwork,
				normReasoner, utilityFunction, operators);

		this.normRefiner = new SIMONENormRefiner(normEvDimensions, 
	...
	public SIMONEOperators getOperators() {
