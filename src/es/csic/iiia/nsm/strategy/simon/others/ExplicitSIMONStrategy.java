 ...
 */
public class ExplicitSIMONStrategy implements NormSynthesisStrategy {
	...
	protected ExplicitSIMONUtilityFunction utilityFunction;	
	protected ExplicitSIMONOperators operators;
	 ...
	 */
	public ExplicitSIMONStrategy(NormSynthesisMachine nsm,
		...
		this.operators = new ExplicitSIMONOperators(this, normReasoner, nsm);
		this.utilityFunction = new ExplicitSIMONUtilityFunction();
...
//					this.specialiseDown(child, visited);
	 ...
	 * @return
	 */
	public ExplicitSIMONOperators getOperators() {
