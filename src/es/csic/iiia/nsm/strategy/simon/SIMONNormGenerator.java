 ...
 *
 */
public class SIMONNormGenerator {
	 ...
	 * 
	 */
	public SIMONNormGenerator(NormSynthesisSettings nsmSettings,
			Monitor monitor, DomainFunctions dmFunctions, SIMONOperators operators) {
