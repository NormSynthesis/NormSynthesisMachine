 ...
 *
 */
public class SIMONPlusNormGenerator {
	 ...
	 * 
	 */
	public SIMONPlusNormGenerator(NormSynthesisSettings nsmSettings,
			Monitor monitor, DomainFunctions dmFunctions, SIMONPlusOperators operators) {
