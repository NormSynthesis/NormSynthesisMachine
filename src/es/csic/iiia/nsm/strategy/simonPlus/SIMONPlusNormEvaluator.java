 ...
 *
 */
public class SIMONPlusNormEvaluator {
	 ...
	 * 
	 */
	public SIMONPlusNormEvaluator(List<Dimension> normEvDimensions, 
			NormSynthesisSettings nsmSettings, DomainFunctions dmFunctions,
			NormativeNetwork normativeNetwork, NormReasoner normReasoner,
			SIMONPlusUtilityFunction utilityFunction, SIMONPlusOperators operators,
